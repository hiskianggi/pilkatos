<?php namespace App\Http\Controllers;
	...
	class AdminElectionDataController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Users Id","name"=>"users_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"users,username"];
			//$this->form[] = ["label"=>"Candidate Id","name"=>"candidate_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"candidate,name"];
